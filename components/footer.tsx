    ...
    <footer className="dark:border-t mt-40 dark bg-background text-foreground">
      <div className="max-w-(--breakpoint-xl) mx-auto">
        <div className="py-12 flex flex-col sm:flex-row items-start justify-between gap-x-8 gap-y-10 px-6 xl:px-0">
          <div>
            {/* Logo */}
            <img src="/download.jpeg" alt="Brysk Logo" style={{ height: 32, width: 'auto', borderRadius: 6 }} />
            ...
            <div className="mt-6 text-sm text-muted-foreground max-w-xs">
              At Brysk, our mission is to make physical retail effortless, intelligent, and accessible—for everyone.
            </div>
          </div>
